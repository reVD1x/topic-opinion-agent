...
async def update_xhs_note(note_item: Dict):
    ...
    local_db_item = {
        "note_id": str(note_item.get("note_id")),  # Note ID
        ...
        "user_id": str(user_info.get("user_id")),  # User ID
        "nickname": user_info.get("nickname"),  # User nickname
        "avatar": user_info.get("avatar"),  # User avatar
        "liked_count": str(interact_info.get("liked_count")),  # Like count
        "collected_count": str(interact_info.get("collected_count")),  # Collection count
        "comment_count": str(interact_info.get("comment_count")),  # Comment count
        "share_count": str(interact_info.get("share_count")),  # Share count
