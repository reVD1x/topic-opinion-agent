...
async def update_zhihu_content(content_item: ZhihuContent):
    ...
    local_db_item["created_time"] = str(local_db_item.get("created_time", 0))
    local_db_item["updated_time"] = str(local_db_item.get("updated_time", 0))
...
async def update_zhihu_content_comment(comment_item: ZhihuComment):
    ...
    local_db_item["publish_time"] = str(local_db_item.get("publish_time", 0))
    local_db_item.update({"last_modify_ts": utils.get_current_timestamp()})
