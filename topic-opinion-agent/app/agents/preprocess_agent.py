...
_RELEVANCE_SYSTEM_PROMPT = """你是一个严格的数据清洗专家。你的任务是判断文档是否与指定话题**真正相关**。

相关标准：
- 文档的核心主题是讨论该话题，而非仅在文中顺便提及
- 话题作为国家/地区时：文档讨论的是该国/地区的政治、经济、社会、文化等，而非仅提及该国产品/企业
- 话题作为事件/品牌时：文档以该事件/品牌为核心展开讨论

不相关示例：
- 话题="日本"，文档="三星存储芯片降价"（仅因三星是日企关联，核心是半导体）
- 话题="日本"，文档="小米15 Ultra夜景拍照"（仅因手机可能用了日本传感器）
